...
def run_inference(text, model, word2idx, intents_list, slots_list):
    ...
    # Raw prediction is a list: [intent_distribution, slots_sequence_distribution]
...
def main():
    ...
    for query in test_queries:
        run_inference(query, model, word2idx, intents_list, slots_list)
